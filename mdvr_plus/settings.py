"""
Django settings for mdvr_plus project.
...
SECRET_KEY = 'gyq=%hu^x(sly7_5)t3)lboeyqj7yr9mwj1&snqo2jy=4^$f=d'
...
WSGI_APPLICATION = 'mdvr_plus.wsgi.application'
...
ASGI_APPLICATION = 'mdvr_plus.routing.application'